...
$ sdtgen scripts/gen-sdt.tcl \
  meta-scobc-v1/recipes-bsp/hdf/files/versal-scobc-v1-ve2302i.xsa \
  meta-scobc-v1/recipes-bsp/sdt/files/versal-scobc-v1-ve2302i

$ gen-machine-conf parse-sdt \
  --hw-description meta-scobc-v1/recipes-bsp/sdt/files/versal-scobc-v1-ve2302i \
  --machine-name versal-scobc-v1-ve2302i-sdt-full \
  -c meta-scobc-v1/conf \
  -g full
----
...
[source,console]
----
$ git restore meta-scobc-v1/conf/machine/<machine-name>.conf
----
====
...
----
$ gen-machine-conf parse-xsa \
  --hw-description meta-scobc-v1/recipes-bsp/hdf/files/versal-scobc-v1-ve2302i.xsa \
